...
public class Course {
    ...
    // REACH at least 95% Code coverage  (assign 3)
    // if student with the name (asurite member) is 
    // not yet included student needs to be added to student list 
    ...
    // REACH at least 95% Code coverage  (assign 3)
    // Students should only be added when they are not 
    // yet in the course (names (asurite member) needs to be unique)
